...
namespace SB.DataAccessLayer
{
    public class DatabaseManager : IDatabaseManager
    {
        ...
        public async Task<object> InsertAsync(string commandText, CommandType commandType, IDbDataParameter[] parameters)
        {
            object result;
            return await Task.Run(() =>
            {
        ...
        public async Task<object> InsertWithTransactionAsync(string commandText, CommandType commandType, IDbDataParameter[] parameters)
        {
            object result = 0;
            return await Task.Run(() =>
            {
        ...
        public async Task<object> InsertWithTransactionAsync(string commandText, CommandType commandType, IsolationLevel isolationLevel, IDbDataParameter[] parameters)
        {
            object result = 0;
            return await Task.Run(() =>
            {
