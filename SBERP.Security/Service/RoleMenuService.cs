...
namespace SBERP.Security.Service
{
    ...
    public class RoleMenuService : IRoleMenuService
    {
        ...
        public async Task<PagingResult<AppUserMenuResponse>?> GetAllAppUserMenuPagingWithSearchAsync(PagingSearchFilter paramRequest)
        {
            try
            {
                ...
                if (Utilities.IsNotNull(dbResult))
                {
                    ...
                    PagingResult<AppUserMenuResponse>? oAppUserMenuResult = JsonConvert.DeserializeObject<PagingResult<AppUserMenuResponse>>(resultJStr);
        ...
        public async Task<DataResponse> GetAppUserRoleMenuInitialDataAsync()
        {
            ...
            try
            {
                ...
                InitialDataResponse? oInitialDataResponse = JsonSerializer.Deserialize<InitialDataResponse>(userMenuMgtFormInitialData, options);
